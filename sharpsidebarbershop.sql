...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 02, 2024 at 05:49 AM
...
(1, 2, 'Fake booking si *****. Di ako sinipot sa appointment date. ', 0, '2024-06-01 19:47:00'),
...
INSERT INTO `appointment_details` (`appointment_id`, `user_id`, `barber_id`, `status_id`, `appointment_deets`, `total_price`, `appointment_date_time`, `is_read`, `date_added`) VALUES
(1, 4, 1, 1, 'Haircut - Price: 150.00\r\nBeard and Mustache Grooming - Price: 75.00\r\n', 225, '2024-06-08 09:45:00', 1, '2024-06-02 01:26:48'),
(2, 4, 2, 2, 'Hair Tattoo - Price: 105.00\r\n', 105, '2024-06-09 08:45:00', 1, '2024-06-01 19:42:06'),
(3, 5, 2, 2, 'Beard and Mustache Grooming - Price: 150.00\r\n', 150, '2024-06-09 08:00:00', 0, '2024-06-01 19:43:05'),
(4, 4, 1, 2, 'Haircut - Price: 150.00\r\nBeard and Mustache Grooming - Price: 75.00\r\n', 225, '2024-06-29 21:20:00', 0, '2024-06-02 01:19:14'),
(5, 4, 2, 1, 'Haircut - Price: 300.00\r\n', 300, '2024-06-03 13:40:00', 1, '2024-06-02 01:30:12');
...
(1000, 82, 500.00, '2024-06-01 19:36:10'),
...
(1, 1, 'July 02, 2024', 0, '2024-06-01 19:43:57'),
(2, 3, 'July 02, 2024', 1, '2024-06-02 01:33:33');
...
(82, 'Haircut', 500.00, '2024-06-01 19:35:32'),
...
(2, 'Barber', 2, 'barber one', 'barber', 'barber', 20, 'Male', 9999999999, 'barber@gmail.com', 'barber house', '2024-06-01 19:28:58'),
...
(7, 'Barber', 1, 'barber4', 'barber4', 'barber4', 23, 'Male', 9445554444, 'barber4@gmail.com', 'sa kanila', '2024-06-01 19:34:52'),
(8, 'Barber', 1, 'Chano Marlon', 'barber5', 'barber5', 20, 'Male', 123456789, 'barber5@gmail.com', 'sugcad', '2024-06-02 01:07:49');
...
--
ALTER TABLE `appointment_details`
  MODIFY `appointment_id` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `feedback`
  MODIFY `feedback_id` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `payment`
--
ALTER TABLE `payment`
  MODIFY `payment_id` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `pricing_junior`
--
ALTER TABLE `pricing_junior`
  MODIFY `pricing_junior_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=895;

--
-- AUTO_INCREMENT for table `pricing_senior`
--
ALTER TABLE `pricing_senior`
  MODIFY `pricing_senior_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=892;

--
-- AUTO_INCREMENT for table `pricing_specialist`
--
ALTER TABLE `pricing_specialist`
  MODIFY `pricing_specialist_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1004;
...
--
ALTER TABLE `report`
  MODIFY `report_id` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
